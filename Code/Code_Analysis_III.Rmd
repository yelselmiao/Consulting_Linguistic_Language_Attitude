...
rec_long_accent %>%
  ...
  # scale_colour_discrete(name = 'Gender', labels=c(paste0("Male (","*n*", "= 39)"),"Female (n = 114)")) + 
  scale_colour_discrete(name = 'Gender', labels=c(expression(paste("Male (", italic("n"), '= 39)')), 
                                                  expression(paste("Female (", italic("n"), '= 114)')))) + 
...
rec_long_accent %>%
  ...
  scale_colour_discrete(name = 'Grew up in Canada', labels=c(expression(paste("FALSE (", italic("n"), '= 35)')), 
                                                  expression(paste("TRUE (", italic("n"), '= 108)')))) + 
  theme(axis.title.x = element_text(size = 12,face = 'bold', hjust = 0.5, vjust = -0.6),
        axis.title.y = element_text(size = 12,face = 'bold', vjust = 3, hjust = 0.5),
        strip.text = element_text(size=12),
        axis.text.y = element_text(size = 10),
...
rec_long_accent %>%
  ...
  scale_colour_discrete(name = 'Grew up in more than one country', labels=c(expression(paste("FALSE (", italic("n"), '= 140)')),
                                                  expression(paste("TRUE (", italic("n"), '= 13)')))) + 
  theme(axis.title.x = element_text(size = 12,face = 'bold', hjust = 0.5, vjust = -0.6),
        axis.title.y = element_text(size = 12,face = 'bold', vjust = 3, hjust = 0.5),
        strip.text = element_text(size=12),
        axis.text.y = element_text(size = 10),
...
rec_long_accent %>%
  ...
  theme_bw() + 
  labs(x = 'Accent', y = 'Mean score') + 
  scale_colour_discrete(name = 'Race of participants', labels=c(expression(paste("Chinese (", italic("n"), '= 22)')),
                                                  expression(paste("Others (", italic("n"), '= 37)')), 
                                                  expression(paste("White (", italic("n"), '= 34)')))) + 
