...
```{r boxplot: grew_up in Canada vs. Speaker Accent}
recording_df_long %>%
...
```{r boxplot: Grew up Continent/Country vs. Speaker Accent, fig.weight = 8, fig.height=4}
continent_df <- recording_df_long %>% 
  ...
  mutate(grow_up_continent = case_when(grow_up_country %in% c('Brunei Darussalam', 'China','Hong Kong (S.A.R.)','India','Indonesia',
                                                      ...
                                                      'United Arab Emirates', 'Vietnam', 'Paskistan') ~ 'Asia',
                               grow_up_country %in% c('Czech Republic', 'Russia', 'UK', 'Ukraine') ~ 'Europe',
                               grow_up_country %in% c('Colombia','Dominica', 'United States of America', 'USA', 'Brazil') ~ 'America (Canada exluded)',
                               grow_up_country %in% c('Ethiopia','Dominica') ~ 'Africa',
