...
ggboxplot(beau_fren_long, x = "accent", y = "value", fill = "accent") + 
  rremove('legend') + 
  ...
  theme(plot.caption = element_text(size=10),
        plot.subtitle=element_text(size=9, vjust= 2, face="italic", color="black")
        )
...
# plot
cowplot::plot_grid(p_dynamic, p_nice, p_social)
