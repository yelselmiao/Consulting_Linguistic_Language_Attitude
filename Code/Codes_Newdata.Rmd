...
```{r}
summary(lm(score ~ accent + race + continent + type_of_french + teacher_origin, data = recording_df_long))
```

```{r}
lme_4 <-  lmer(score ~ race + accent + continent + type_of_french + teacher_origin +  (1 + accent|id), data = as.data.frame(recording_df_long))
summary(lme_4,correlation=TRUE)
```
